 ...
 public:
    ...
    */
   void Opt(IntVector& opt) const { keeper->Opt(opt); };
   /**
    ...
    */
   void OptSwitches(ParameterVector& sw) const { keeper->OptSwitches(sw); };
   /**
    ...
    */
   void InitialValues(DoubleVector& val) const { keeper->InitialValues(val); };
   /**
    ...
    */
   void CurrentValues(DoubleVector& val) const { keeper->CurrentValues(val); };
   /**
    * \brief This function will return a copy the initial value of the variables to be optimised
    * \param val is the DoubleVector that will contain a copy of the initial values
    */
   void InitialOptValues(DoubleVector& val) const { keeper->InitialOptValues(val); };
   /**
    ...
    */
   void ScaledOptValues(DoubleVector& val) const { keeper->ScaledOptValues(val); };
   /**
    ...
    */
   void LowerOptBds(DoubleVector& lbs) const { keeper->LowerOptBds(lbs); };
   /**
    ...
    */
   void UpperOptBds(DoubleVector& ubs) const { keeper->UpperOptBds(ubs); };
   /**
