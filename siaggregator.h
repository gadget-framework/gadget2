#ifndef siaggregator_h
#define siaggregator_h
...
/**
 * \class SIAggregator
 * \brief This is the class used to aggregate stock information for survey index calculations
 */
class SIAggregator {
public:
  /**
   * \brief This is the SIAggregator constructor
   ...
   */
  SIAggregator(const StockPtrVector& Stocks, const LengthGroupDivision* const LgrpDiv,
    const IntMatrix& Areas, const IntMatrix& Ages);
  /**
   * \brief This is the default SIAggregator destructor
   */
  ~SIAggregator();
  /**
