...
\subsection{Hockey stick Recruitment Function}
This recruitment function calculates the number of recruits to be
added to the spawned stock, as a function of the spawning stock
biomass (see equation~\ref{eq:ssb}), based on the Hockey stick recruitment relationship given by the following equation:
