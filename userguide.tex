...
\item the current directory (ie. from where Gadget was started) if these environment variables have not been set
\end{enumerate}
...
\item check that each prey is not ''over-consumed''.
