...
\ell = \sum_{\it time}\sum_{\it areas} \bigg( \log \big(\sum_{\it ages}\sum_{\it lengths} \widehat{I}_{al} \big) - {\frac { \displaystyle \sum_{\it ages}\sum_{\it lengths} \big(\widehat{I}_{al} \log (I_{al} + \epsilon) \big)} { \displaystyle \sum_{\it ages}\sum_{\it lengths} I_{al}} } \bigg)
\end{equation}
...
This is the criteria for halting the BFGS algorithm at a minimum, and accepting the current point as the 'solution'.  The algorithm has ''converged'' if ...
